...
def plot_evolution(state_t0, state_t1, state_t100, state_t10000, grid, hydro,
    ...
    axes[0, 0].plot(r_int, prim_1['rho0'][NUM_GHOSTS:-NUM_GHOSTS], 'orange', linestyle='--', linewidth=1.5, label=f't=1/3 (t={t_1:.6e})')
    if t_100 != t_10000:  # Only plot if different from final
        axes[0, 0].plot(r_int, prim_100['rho0'][NUM_GHOSTS:-NUM_GHOSTS], 'green', linestyle='-.', linewidth=1.5, label=f't=2/3 (t={t_100:.6e})')
    axes[0, 0].plot(r_int, prim_10000['rho0'][NUM_GHOSTS:-NUM_GHOSTS], 'red', linestyle=':', linewidth=1.5, label=f't=final (t={t_10000:.6e})')
    axes[0, 0].set_xlabel('r')
    axes[0, 0].set_ylabel(r'$\rho_0$')
    ...
    axes[0, 1].plot(r_int, np.maximum(prim_1['p'][NUM_GHOSTS:-NUM_GHOSTS], 1e-20), 'orange', linestyle='--', linewidth=1.5, label=f't=1/3 (t={t_1:.6e})')
    if t_100 != t_10000:
        axes[0, 1].plot(r_int, np.maximum(prim_100['p'][NUM_GHOSTS:-NUM_GHOSTS], 1e-20), 'green', linestyle='-.', linewidth=1.5, label=f't=2/3 (t={t_100:.6e})')
    axes[0, 1].plot(r_int, np.maximum(prim_10000['p'][NUM_GHOSTS:-NUM_GHOSTS], 1e-20), 'red', linestyle=':', linewidth=1.5, label=f't=final (t={t_10000:.6e})')
    axes[0, 1].set_xlabel('r')
    axes[0, 1].set_ylabel('P')
    ...
    axes[1, 0].plot(r_int, prim_1['vr'][NUM_GHOSTS:-NUM_GHOSTS], 'orange', linestyle='--', linewidth=1.5, label=f't=1/3 (t={t_1:.6e})')
    if t_100 != t_10000:
        axes[1, 0].plot(r_int, prim_100['vr'][NUM_GHOSTS:-NUM_GHOSTS], 'green', linestyle='-.', linewidth=1.5, label=f't=2/3 (t={t_100:.6e})')
    axes[1, 0].plot(r_int, prim_10000['vr'][NUM_GHOSTS:-NUM_GHOSTS], 'red', linestyle=':', linewidth=1.5, label=f't=final (t={t_10000:.6e})')
    axes[1, 0].set_xlabel('r')
