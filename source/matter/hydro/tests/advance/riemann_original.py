...
ORIGINAL VERSION (sin JIT) - para benchmark de comparación.
...
class HLLRiemannSolverOriginal:
    ...
    def solve_batch(self, UL_batch, UR_batch, primL_batch, primR_batch,
        ...
        """
        Fully vectorized solver for multiple interfaces - VERSION ORIGINAL.
